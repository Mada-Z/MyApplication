...
class LabradorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val labradorView: ImageView = findViewById(R.id.labradorView)

        labradorView.setImageResource(itemModel!!.image)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if(item.itemId == R.id.share){
            ...
            val shareIntent = Intent().apply{
                ...
                val textView : TextView = findViewById(R.id.labradorText)
